...
Focus: regulation, confidence, connection and learning that sticks.
      ...
      <section className="pricing-container speakable-block" aria-labelledby="pricing-title" style={{
        ...
        <ReadAloudButton text="Pricing. At Regulate2Learn, pricing reflects the depth of support offered to neurodivergent and neurotypical children, parents and educators. Every session is regulation‑first, sensory-aware and grounded in compassion - never pressure. Regulation‑Based Tutoring (1:1): £40-£70 per hour. Support for autistic, ADHD, anxious, sensory‑sensitive, overwhelmed or shutdown‑prone learners. Includes RRE‑based curriculum support and SenseMaths. Focus: regulation, confidence, connection, and learning that sticks. Parent Support & Coaching: £45-£80 per hour. Gentle, practical guidance for behaviour, regulation and learning at home. Understand your child’s nervous system, reduce overwhelm and build connection. Teacher Support (neurodivergent teachers): £40-£75 per hour. Regulation‑first teaching strategies, sensory‑friendly adjustments, scripts for tricky moments, and confidence‑building for teachers who don’t fit the stereotype. Behaviour Understanding Sessions: £45-£85 per hour. For parents and teachers who want to understand shutdowns, meltdowns, fidgeting, avoidance, talking back, masking, transitions and overwhelm. Behaviour is communication - we decode what it’s saying. SenseMaths Sessions: £35-£65 per hour. Maths support for neurodivergent learners using sensory‑based, relational, regulation‑first methods. Curriculum Support Across Subjects: £30-£55 per hour. Reading, writing, maths and general learning support - always through a regulation‑first lens. What’s Included in Every Session: Regulation‑first approach, Sensory‑aware strategies, Connection‑based teaching, Personalised adjustments, Calm, compassionate support, Optional follow‑up notes (service‑dependent)." />
