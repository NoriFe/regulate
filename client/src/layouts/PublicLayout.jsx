  ...
  return (
    <div className="site-shell">
      ...
      <footer className="site-footer">
        <div className="site-footer__inner speakable-block">
          <div className="site-footer__identity">
            <p className="site-footer__line">{t("common.footerBrandLine")}</p>
            <p className="site-footer__line">{t("common.footerSenseMaths")}</p>
            <p className="site-footer__line">{t("common.footerRre")}</p>
          </div>

          <div className="site-footer__contact">
            <p className="site-footer__label">{t("common.footerContactEmailLabel")}</p>
            <a className="site-footer__email" href={`mailto:${t("common.footerContactEmail")}`}>
